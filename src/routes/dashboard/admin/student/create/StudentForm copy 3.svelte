...
<form on:submit={onSubmit}>
	...
	<div class="card-wrapper">
		...
		<div class="grid-12">
			...
			<div class="col-2">
				...
				<select id="gender" class={`w-full ${$formErrors.gender && ($touched.gender || $submitAttempted) ? "input-error" : ""}`} bind:value={formData.gender} on:change={validate}>
	...
	<div class="card-wrapper">
		...
		<div class="grid-12">
			<div class="col-4">
				<label for="lastName">House No/Street</label>
				<input id="lastName" type="text" name="lastName" class="w-full" bind:value={formData.middleName} />
			</div>
	...
	<div class="card-wrapper">
		...
		<div class="grid-12">
			...
			<div class="col-1">
				<label for="admissionNo">Height (CM)</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-1">
				<label for="admissionNo">Weight (KG)</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-1">
				<label for="admissionNo">Eye Sight</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionDate">Measurement Date</label>
				<DatePicker bind:value={selectedDate} onChange={handleDateChange} defaultToday={true} />
			</div>

			<div class="col-6">
				<label for="medicalHistory">Medical History</label>
				<!-- <textarea id="medicalHistory" name="medicalHistory" placeholder="Write medial history.."></textarea> -->
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-6">
				<label for="medicalHistory">Allergies</label>
				<TagInput />
			</div>

			<div class="col-6">
				<label for="medicalHistory">Medical Conditions</label>
				<TagInput />
			</div>
		</div>
	</div>
	...
	<div class="card-wrapper">
		...
		<div class="grid-12">
			<div class="col-2">
				<label for="admissionNo">Father Name</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionNo">Father Phone</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionNo">Father Occupation</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionNo">Father Education</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-4">
				<label for="admissionNo">Father Email</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionNo">Mother Name</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionNo">Mother Phone</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionNo">Mother Occupation</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-2">
				<label for="admissionNo">Mother Education</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>
			<div class="col-4">
				<label for="admissionNo">Mother Email</label>
				<input id="admissionNo" type="text" bind:value={formData.firstName} />
			</div>

			<div class="col-6">
				<label for="studentAddress">Parent Current Address</label>
				<textarea id="studentAddress" name="studentAddress" placeholder="Write current address.."></textarea>
			</div>

			<div class="col-6">
				<label for="studentAddress">Parent Permanent Address</label>
				<textarea id="studentAddress" name="studentAddress" placeholder="Write current address.."></textarea>
			</div>

			<div class="col-2">
				<label for="admissionNo">Primary Guardian</label>
				<div class="radio-group">
					<label><input type="radio" value="Father" /> Father </label>
					<label><input type="radio" value="Mother" /> Mother </label>
            ...
            <div class="col-12">
                <div class="grid-12">
                    <div class="col-2">
                        <label for="admissionNo">Guardian Name</label>
                        <input id="admissionNo" type="text" bind:value={formData.firstName} />
                    </div>
        
                    <div class="col-2">
                        <label for="admissionNo">Guardian Phone</label>
                        <input id="admissionNo" type="text" bind:value={formData.firstName} />
                    </div>
        
                    <div class="col-2">
                        <label for="admissionNo">Guardian Occupation</label>
                        <input id="admissionNo" type="text" bind:value={formData.firstName} />
                    </div>
        
                    <div class="col-2">
                        <label for="admissionNo">Guardian Education</label>
                        <input id="admissionNo" type="text" bind:value={formData.firstName} />
                    </div>
        
                    <div class="col-2">
                        <label for="admissionNo">Guardian Relation</label>
                        <input id="admissionNo" type="text" bind:value={formData.firstName} />
                    </div>
        
                    <div class="col-2">
                        <label for="admissionNo">Guardian Email</label>
                        <input id="admissionNo" type="text" bind:value={formData.firstName} />
                    </div>
        
                    <div class="col-6">
                        <label for="studentAddress">Guardian Current Address</label>
                        <textarea id="studentAddress" name="studentAddress" placeholder="Write current address.."></textarea>
                    </div>
        
                    <div class="col-6">
                        <label for="studentAddress">Guardian Permanent Address</label>
                        <textarea id="studentAddress" name="studentAddress" placeholder="Write current address.."></textarea>
                    </div>
                </div>
            </div>
			...
			<div class="card-wrapper col-12">
				...
				<div class="grid-12">
					...
					<div class="col-8">
						...
						<textarea id="studentAddress" name="studentAddress" placeholder="Write address.."></textarea>
					</div>
				</div>
			</div>
			<div class="card-wrapper col-12">
				...
				<div class="grid-12">
					...
					<div class="col-4">
						<label for="lastName">Father Phone</label>
						<input id="lastName" type="text" name="lastName" class="w-full" bind:value={formData.middleName} />
					</div>

					<div class="col-4">
						<label for="lastName">Father Occupation</label>
						<input id="lastName" type="text" name="lastName" class="w-full" bind:value={formData.lastName} />
					</div>
					...
					<div class="col-4">
						<label for="lastName">Mother Phone</label>
						<input id="lastName" type="text" name="lastName" class="w-full" bind:value={formData.middleName} />
					</div>

					<div class="col-4">
						<label for="lastName">Mother Occupation</label>
						<input id="lastName" type="text" name="lastName" class="w-full" bind:value={formData.lastName} />
					</div>
...
<!-- <div class="card-wrapper col-12">
        ...
        <div class="grid-12">
            ...
            <div class="col-3">
                <label for="admissionNo">Height</label>
                <input id="admissionNo" type="text" bind:value={formData.firstName} />
            </div>

            <div class="col-3">
                <label for="admissionNo">Weight</label>
                <input id="admissionNo" type="text" bind:value={formData.firstName} />
            </div>
