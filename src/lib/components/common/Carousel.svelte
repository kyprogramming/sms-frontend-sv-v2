...
<!-- prettier-ignore -->
<style>
	.carousel { position: relative; width: 100%; max-width: 100%; overflow: hidden; border-radius: 0.5rem; /* margin-top: 10px; */ }
	.carousel-track { display: flex; transition: transform 0.5s ease-in-out; }
	.carousel-item { min-width: 100%; transition: transform 0.2s ease; }
	...
	.indicator { width: 0.75rem; height: 0.75rem; background-color: rgba(255, 255, 255, 0.6); border-radius: 999px; cursor: pointer; transition: background-color 0.2s; }
