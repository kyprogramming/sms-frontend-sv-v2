...
export const MENU_GROUPS = [
	...
	// 	icon: "UserPen",
	// 	items: [
	// 		{ title: "Teacher List", link: "/admin/student/list" },
	// 		{ title: "Assign Class Teacher", link: "/admin/student/create" },
	// 		// { title: "Student Delete", link: "/admin/student/delete"},
	// 		// { title: "Student View", link: "/admin/student/view"},
	// 		// { title: "Online Admission", link: "/admin/onlinestudent" },
	// 		// { title: "Disabled Students", link: "/student/disablestudentslist" },
	...
	},
	{
		...
		icon: 'IndianRupee',
		items: [
			{ title: 'Fee Types', link: '/admin/fee-type' },
			{ title: 'Fee Groups', link: '/admin/fee-group' },
			{ title: 'Fee Discounts', link: '/admin/fee-discount' },
